...
const COPY = {
  tr: {
    title: "Kullan?c? Ana Sayfas?",
    subtitle: "G?nl?k takibini, planlar?n? ve hesap ?zetini tek ekranda y?net.",
    welcome: "Tekrar ho? geldin",
    fallbackUser: "Kullan?c?",
    profile: "Profil",
    logout: "??k?? Yap",
    overview: "Genel Bak??",
    overviewSub: "Hesab?na ba?l? g?ncel ?zet kartlar?",
    summaryErr: "?zet verileri ?u anda al?nam?yor.",
    statPlans: "Planlar",
    statMessages: "Mesajlar",
    statAdherence: "Uyum",
    statExperts: "Aktif Uzmanlar",
    quickTitle: "H?zl? ??lemler",
    quickSub: "En s?k kullan?lan alanlara h?zl? eri?im",
    quickProfile: "Profilini G?ncelle",
    quickProfileText: "Ki?isel bilgilerini ve ileti?im alanlar?n? d?zenle.",
    quickStart: "S?re? ?zetini ?ncele",
    quickStartText: "Kay?t sonras? s?recini tek bak??ta g?zden ge?ir.",
    quickSupport: "Destek ve ?leti?im",
    quickSupportText: "Diyetisyenin ve uygulama ak???yla ilgili y?nlendirme al.",
    activityTitle: "Bug?n ??in",
    activitySub: "Platformu verimli kullanmak i?in ?nerilen g?nl?k ak??",
    activityA: "Profil alanlar?n? tamamla ve hesab?n? g?ncel tut.",
    activityB: "Planlar?n geldik?e g?nl?k takibini ayn? ekrandan izleyebilirsin.",
    activityC: "?l??mlerini d?zenli girerek ilerleme ge?mi?ini g??lendir.",
    accountTitle: "Hesap Bilgileri",
    accountSub: "Giri? yapt???n hesaba ait ?zet bilgiler",
    mail: "E-posta",
    phone: "Telefon",
    status: "Durum",
    statusActive: "Aktif kullan?c? hesab?",
    statusReady: "Kullan?ma haz?r",
    measurements: "?l??m Ge?mi?i",
    measurementsSub: "Son 30 g?nl?k kay?tlara ait k?sa bir g?r?n?m",
    latestWeight: "G?ncel Kilo",
    latestFat: "G?ncel Ya? Oran?",
    recentRecords: "Son Kay?tlar",
    notesTitle: "G?nl?k Notlar",
    notesSub: "Bu alan yaln?zca sana ?zeldir ve taray?c?nda saklan?r.",
    notesPlaceholder: "Bug?n neye odaklanmak istiyorsun?",
    workspaceTitle: "Kullan?c? Ak???",
    workspaceSub: "Uygulamada izleyece?in temel kullan?c? ad?mlar?.",
    assignedTitle: "Atanm?? Diyetisyen",
    assignedSub: "Bu e?le?me admin taraf?ndan y?netilir ve kullan?c? taraf?ndan do?rudan de?i?tirilemez.",
    assignedNone: "Hen?z sana atanm?? bir diyetisyen bulunmuyor.",
    assignedClinic: "Klinik",
    assignedCity: "?ehir",
    assignedNote: "Ba?lant? Notu",
    w1: "Profilini ve hedeflerini tamamla",
    w1d: "Ki?isel bilgilerini, ileti?im alanlar?n? ve temel hedeflerini g?ncel tut.",
    w2: "?l??mlerini kaydet",
    w2d: "Kilo ve ya? oran? gibi verileri d?zenli girerek ilerlemeni takip et.",
    w3: "Plan?n? takip et",
    w3d: "Diyetisyenden gelen plan, uyum ve g?nl?k ak?? kartlar?n? buradan izle.",
    w4: "Destek al ve not tut",
    w4d: "Sorular?n? toparla, g?nl?k not alan?n? kullan ve profil ekran? ?zerinden s?reci destekle.",
    noMeasurements: "Hen?z ?l??m kayd? bulunmuyor.",
    measurementErr: "?l??m verileri ?u anda al?nam?yor.",
    empty: "Belirtilmedi",
  },
  en: {
    title: "User Home",
