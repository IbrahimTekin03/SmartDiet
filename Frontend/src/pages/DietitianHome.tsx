...
const COPY = {
  tr: {
    subtitle: "Dan??an s?recini, plan y?netimini ve g?nl?k klinik ak???n? tek ekranda takip et.",
    welcome: "Ho? geldin",
    clinic: "Klinik",
    ...
    logout: "??k?? Yap",
    overview: "Klinik ?zeti",
    overviewSub: "Bug?nk? ?al??ma ak???n? destekleyen temel kartlar",
    summaryErr: "?zet verileri ?u anda al?nam?yor.",
    statClients: "Aktif Dan??anlar",
    statPlans: "Planlar",
    statMessages: "Mesajlar",
    statAdherence: "Uyum",
    actions: "H?zl? Eri?im",
    actionsSub: "G?n i?inde en s?k kullanaca??n alanlar",
    a1: "Profil ve klinik bilgilerini d?zenle",
    a1d: "G?r?n?rl?k ve ileti?im alanlar?n? g?ncel tut.",
    a2: "Dan??an s?recini takip et",
    a2d: "Plan, ilerleme ve ileti?im ak???n? tek yerden y?net.",
    a3: "G?nl?k ?al??ma notlar?",
    a3d: "Bug?n ?ncelik vermen gereken ad?mlar? h?zl?ca g?zden ge?ir.",
    today: "Bug?n ??in",
    todaySub: "Pratik g?nl?k odak listesi",
    t1: "Yeni dan??an ve plan ihtiya?lar?n? k?sa bir ?n de?erlendirme ile belirle.",
    t2: "Mesaj alanlar?n? g?n i?inde toplu kontrol ederek ak??? h?zland?r.",
    t3: "Klinik bilgilerini ve profesyonel profilini g?venli ?ekilde g?ncel tut.",
    account: "Profesyonel Kart",
    accountSub: "Oturum ve hesap ?zetin",
    notesTitle: "G?nl?k Klinik Notu",
    notesSub: "Yaln?zca bu cihazda saklanan k?sa ?al??ma notlar?.",
    notesPlaceholder: "Bug?n hangi dan??anlar? ya da i?leri ?nceliklendireceksin?",
    assignedTitle: "Ba?l? Dan??anlar",
    assignedSub: "Bu liste, admin taraf?ndan tan?mlanan aktif e?le?melerden olu?ur.",
    assignedNone: "Hen?z sana ba?l? aktif dan??an bulunmuyor.",
    assignedNote: "E?le?me Notu",
    workspaceTitle: "Diyetisyen Ak???",
    workspaceSub: "Uygulama i?inde y?netti?in temel profesyonel ?al??ma ak???.",
    w1: "Yeni dan??anlar? de?erlendir",
    w1d: "?zet kartlar, notlar ve g?nl?k odak listesi ile hangi dan??ana ?nce d?n?? yapaca??n? belirle.",
    w2: "Plan ve takip y?netimi",
    w2d: "Plan, uyum ve ilerleme ak???n? tek merkezden y?netmeye haz?r bir alan kullan.",
    w3: "?l??m yorumlama",
    w3d: "Dan??an ?l??mlerini izleyerek de?i?im noktalar?n? klinik karara d?n??t?r.",
    w4: "?leti?im ve tempo",
    w4d: "Mesaj, not ve g?nl?k ?al??ma temposunu birlikte y?net.",
    mail: "E-posta",
    status: "Durum",
    statusValue: "Onayl? diyetisyen hesab?",
    ready: "Dan??an kabul?ne haz?r",
    empty: "Belirtilmedi",
  },
  en: {
