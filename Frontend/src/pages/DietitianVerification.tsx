...
const COPY = {
  tr: {
    title: "Diyetisyen Do?rulamas?",
    subtitle: "Diyetisyen paneline eri?meden ?nce klinik bilgilerini eksiksiz ?ekilde iletmelisin.",
    loading: "Y?kleniyor...",
    statusApproved: "Ba?vurun onayland?. Diyetisyen ana sayfas?na y?nlendiriliyorsun.",
    statusPending: "Ba?vurun inceleme s?recinde. Admin onay?n?n ard?ndan diyetisyen ekran?n a??lacak.",
    statusRejected: "Ba?vurun reddedildi. Bilgilerini g?ncelleyerek yeniden g?nderebilirsin.",
    rejectReasonTitle: "Red Nedeni",
    statusDatesTitle: "Ba?vuru Detay?",
    submittedAt: "G?nderim Tarihi",
    reviewedAt: "?nceleme Tarihi",
    fieldClinicName: "Klinik Ad?",
    fieldCity: "?ehir",
    fieldAddress: "Adres",
    fieldLicense: "Lisans / Belge No",
    fieldNote: "Ek Not (opsiyonel)",
    requiredError: "L?tfen t?m zorunlu alanlar? doldur.",
    submitSuccess: "Ba?vurun admin onay?na g?nderildi.",
    submitLoading: "G?nderiliyor...",
    submitButton: "Do?rulama Ba?vurusu G?nder",
    resubmitButton: "Bilgileri G?ncelle ve Yeniden G?nder",
    backProfile: "Profile D?n",
    genericError: "Beklenmeyen bir hata olu?tu.",
    statusFetchError: "Do?rulama durumu al?namad?.",
    submitError: "Ba?vuru g?nderilemedi. L?tfen tekrar dene.",
  },
  en: {
