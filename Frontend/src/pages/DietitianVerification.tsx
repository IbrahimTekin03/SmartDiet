...
const COPY = {
  tr: {
    ...
    subtitle: "Diyetisyen paneline erişmeden önce klinik bilgilerini eksiksiz şekilde iletmelisin.",
    loading: "Yükleniyor...",
    statusApproved: "Başvurun onaylandı. Diyetisyen ana sayfasına yönlendiriliyorsun.",
    statusPending: "Başvurun inceleme sürecinde. Admin onayının ardından diyetisyen ekranın açılacak.",
