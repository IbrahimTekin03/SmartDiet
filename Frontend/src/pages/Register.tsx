...
> = {
  tr: {
    ...
    signIn: "Giris Yap",
    headChip: "Hesabini olustur ve klinigini yonet",
    titleA: "SmartDiet'e",
    titleB: "kayit ol",
    subtitle: "Danisanlarini yonet, planlarini olustur, olcum tarihcesini takip et ve mesajlasmayi tek panelden yurut.",
    pillA: "Abonelik",
    pillAText: "Aktif / dondur / iptal",
    pillB: "Olcum",
    pillBText: "Tarihceli takip",
    pillC: "Sohbet",
    pillCText: "Fotograf ve goruldu",
    cardTitle: "Kayit Olustur",
    cardSub: "Email veya telefon alanlarindan en az birini doldur.",
    successMsg: "Kayit basariyla olusturuldu. Giris yapmak ister misin?",
    toLoginBtn: "Girise Git",
    firstName: "Isim",
    lastName: "Soyisim",
    firstNamePh: "Isim",
    lastNamePh: "Soyisim",
    ...
    female: "Kadin",
    password: "Sifre",
    passHint: "En az 8 karakter, 1 buyuk, 1 kucuk, 1 rakam, 1 ozel (@$!%*?&)",
    hide: "Gizle",
    show: "Goster",
    submitBusy: "Kayit olusturuluyor...",
    submit: "Kayit Ol",
    haveAccount: "Zaten hesabin var mi?",
    toLogin: "Giris yap",
    firstReq: "Isim zorunlu.",
    ...
    contactReq: "E-posta veya telefon alanlarindan en az biri zorunlu.",
    invalidEmail: "Gecerli bir e-posta gir.",
    invalidPhone: "Gecerli bir telefon gir. Ornek: +905555555555",
    registerFail: "Kayit basarisiz. Bilgileri kontrol et.",
          ...
          <div className={isDark ? "rounded-[26px] border border-white/10 bg-white/5 p-5 shadow-[0_40px_140px_rgba(0,0,0,0.65)] backdrop-blur sm:p-7" : "rounded-[26px] border border-[#325d51]/25 bg-[#eaf2ed]/84 p-5 shadow-[0_40px_120px_rgba(8,22,20,0.12)] backdrop-blur sm:p-7"}>
            ...
            {duplicateContact ? (
              <div className={isDark ? "mb-4 flex items-center justify-between gap-3 rounded-xl border border-amber-400/30 bg-amber-500/10 px-4 py-3 text-sm text-amber-100" : "mb-4 flex items-center justify-between gap-3 rounded-xl border border-amber-700/35 bg-amber-100 px-4 py-3 text-sm text-amber-900"}>
                <span>{lang === "tr" ? "Bu e-posta/telefon zaten kayitli. Giris yapmak ister misin?" : "This email/phone is already registered. Do you want to sign in?"}</span>
                <button
                  type="button"
                ...
                >
                  {lang === "tr" ? "Girise Git" : "Go to Sign In"}
                </button>
              </div>
            ) : null}
            {successMsg ? (
