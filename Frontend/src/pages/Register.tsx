...
> = {
  tr: {
    ...
    signIn: "Giri? Yap",
    headChip: "Hesab?n? olu?tur ve platforma g?venle ba?la",
    titleA: "SmartDiet'e",
    titleB: "kay?t ol",
    subtitle: "Dan??an y?netimi, plan olu?turma, ?l??m takibi ve ileti?im s?re?lerini tek panelden y?r?t.",
    pillA: "Abonelik",
    pillAText: "Aktif / dondur / iptal",
    pillB: "?l??m",
    pillBText: "Ge?mi?e d?n?k takip",
    pillC: "Sohbet",
    pillCText: "Foto?raf ve g?r?ld? bilgisi",
    cardTitle: "Kay?t Olu?tur",
    cardSub: "E-posta veya telefon alanlar?ndan en az birini doldurarak hesab?n? olu?tur.",
    successMsg: "Kay?t ba?ar?yla olu?turuldu. ?imdi giri? yapabilirsin.",
    toLoginBtn: "Giri?e Git",
    firstName: "?sim",
    lastName: "Soyisim",
    firstNamePh: "?sim",
    lastNamePh: "Soyisim",
    ...
    gender: "Cinsiyet",
    accountType: "Hesap T?r?",
    clientType: "Kullan?c?",
    dietitianType: "Diyetisyen",
    male: "Erkek",
    female: "Kad?n",
    password: "?ifre",
    passHint: "En az 8 karakter; b?y?k harf, k???k harf, rakam ve ?zel karakter i?ermelidir.",
    hide: "Gizle",
    show: "G?ster",
    submitBusy: "Kay?t olu?turuluyor...",
    submit: "Kay?t Ol",
    haveAccount: "Zaten hesab?n var m??",
    toLogin: "Giri? yap",
    firstReq: "?sim zorunludur.",
    lastReq: "Soyisim zorunludur.",
    birthReq: "Do?um tarihi zorunludur.",
    birthFormat: "Ge?erli format: YYYY-MM-DD",
    ageRule: "Kay?t olmak i?in en az 18 ya??nda olmal?s?n.",
    genderReq: "Cinsiyet se?imi zorunludur.",
    passReq: "?ifre zorunludur.",
    passRule: "?ifren en az 8 karakter olmal?; b?y?k harf, k???k harf, rakam ve ?zel karakter i?ermelidir.",
    contactReq: "E-posta veya telefon alanlar?ndan en az biri zorunludur.",
    invalidEmail: "Ge?erli bir e-posta adresi gir.",
    invalidPhone: "Ge?erli bir telefon numaras? gir. ?rnek: +905555555555",
    registerFail: "Kay?t olu?turulamad?. Bilgilerini kontrol ederek tekrar dene.",
