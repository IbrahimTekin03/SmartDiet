...
> = {
  tr: {
    ...
    signIn: "Giriş Yap",
    headChip: "Hesabını oluştur ve kliniğini yönet",
    titleA: "SmartDiet'e",
    titleB: "kayıt ol",
    subtitle: "Danışanlarını yönet, planlarını oluştur, ölçüm tarihçesini takip et ve mesajlaşmayı tek panelden yürüt.",
    pillA: "Abonelik",
    pillAText: "Aktif / dondur / iptal",
    pillB: "Ölçüm",
    pillBText: "Tarihçeli takip",
    pillC: "Sohbet",
    pillCText: "Fotoğraf ve görüldü",
    cardTitle: "Kayıt Oluştur",
    cardSub: "E-posta veya telefon alanlarından en az birini doldur.",
    successMsg: "Kayıt başarıyla oluşturuldu. Giriş yapmak ister misin?",
    ...
    clientType: "Normal Kullanıcı",
    dietitianType: "Diyetisyen",
    male: "Erkek",
    female: "Kadın",
    password: "Şifre",
    passHint: "En az 8 karakter, 1 büyük, 1 küçük, 1 rakam, 1 özel (@$!%*?&)",
    hide: "Gizle",
    show: "Göster",
    ...
    toLogin: "Giriş yap",
    firstReq: "İsim zorunlu.",
    lastReq: "Soyisim zorunlu.",
    birthReq: "Doğum tarihi zorunlu.",
    birthFormat: "Geçerli format: YYYY-MM-DD",
    ageRule: "Kayıt için en az 18 yaşında olmalısın.",
    genderReq: "Cinsiyet zorunlu.",
    passReq: "Şifre zorunlu.",
    passRule: "Şifre: en az 8 karakter, büyük, küçük, rakam ve özel karakter içermeli.",
    contactReq: "E-posta veya telefon alanlarından en az biri zorunlu.",
    invalidEmail: "Geçerli bir e-posta gir.",
    invalidPhone: "Geçerli bir telefon gir. Örnek: +905555555555",
    registerFail: "Kayıt başarısız. Bilgileri kontrol et.",
