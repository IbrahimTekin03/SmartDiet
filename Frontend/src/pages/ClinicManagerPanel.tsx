...
const COPY = {
  tr: {
    load: "Panel haz?rlan?yor",
    tag: "Klinik Y?netimi",
    title: "Onayl? diyetisyen operasyonu",
    subtitle:
      "Klini?e ba?l? diyetisyenleri tek ekrandan izle, filtrele ve aktiflik durumlar?n? g?venli bi?imde y?net.",
    welcome: "Ho? geldin",
    profile: "Profil",
    logout: "??k?? Yap",
    refresh: "Yenile",
    ...
    visible: "G?r?nen Kay?t",
    listTitle: "Diyetisyen Listesi",
    listSub: "Arama, filtre ve se?im ak???n? tek b?l?mde toplad?k.",
    ...
    listEmpty: "Bu filtrelerle g?sterilecek diyetisyen bulunamad?.",
    detailTitle: "Se?ili Diyetisyen",
    detailSub: "Detay, ileti?im ve operasyon notlar?",
    detailEmpty: "Soldaki listeden bir diyetisyen se?.",
    clinic: "Klinik",
    email: "E-posta",
    phone: "Telefon",
    cityLabel: "?ehir",
    ...
    inactiveState: "Pasif",
    verified: "Do?rulanm??",
    unverified: "Do?rulanmam??",
    activate: "Hesab? Aktifle?tir",
    deactivate: "Hesab? Pasifle?tir",
    updating: "G?ncelleniyor...",
    listErr: "Diyetisyen listesi al?namad?.",
    updateErr: "Aktiflik durumu g?ncellenemedi.",
    noData: "Belirtilmedi",
    page: "Sayfa",
    prev: "?nceki",
    next: "Sonraki",
    opsTitle: "Operasyon Merkezi",
    opsSub: "Bug?nk? tarama ak???n? h?zland?ran ?zet alan",
    opsA: "Se?ili ki?inin ileti?im bilgisini tek t?kla kopyalayabilirsin.",
    opsB: "Filtreler g?r?nen listeye uygulan?r; ?st kartlar mevcut sayfay? yans?t?r.",
    opsC: "Sayfa a??k kald???nda liste 30 saniyede bir yenilenir.",
    copyMail: "E-postay? Kopyala",
    copyPhone: "Telefonu Kopyala",
    copied: "Bilgi panoya kopyaland?.",
    fallbackManager: "Klinik Y?neticisi",
  },
  en: {
