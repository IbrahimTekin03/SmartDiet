      ...
      <nav className={`sticky top-0 z-40 w-full border-b backdrop-blur-xl transition-all duration-200 ${
        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-2 sm:gap-2.5">
            <Link
              to="/features"
              title={lang === "tr" ? "Platform Özellikleri" : "Features"}
              className={`hidden md:inline-flex items-center gap-1.5 rounded-2xl border px-3 py-1.5 text-xs font-bold transition-all hover:scale-[1.02] ${
                isDark 
